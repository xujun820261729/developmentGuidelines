<!-- 
1. :tag : vue 默认 span 这里需要使用div
2. <slot :loading="loading"></slot> : 传参插槽
3. 官网 ：https://github.com/xunleif2e/vue-lazy-component
-->
<template>
  <transition-group 
   :tag="tagName" 
    name="lazy-component" style="position: relative;"
  ...
  export default {
    ...
    methods: {
      ...
      intersectionHandler (entries) {
        console.log('intersectionHandler', entries);
        if (
          // 正在交叉
